...
<body>
	<form
		action="${pageContext.request.contextPath }/itemSelectList.action"
		method="get">
		查询条件：
		<table width="100%" border=1>
			<tr>
				...
				<td><input type="submit" value="查询" />
						&nbsp&nbsp&nbsp
					<a href="${pageContext.request.contextPath }/itemAddView.action">添加</a>
					&nbsp&nbsp&nbsp
					<a href="${pageContext.request.contextPath }/itemExport.action">导出</a>
				</td>
			</tr>
		</table>
		商品列表：
			...
			<c:forEach items="${itemList}" var="item">
				<tr>
					...
					<td><a
						...
						&nbsp&nbsp&nbsp
						<a
						href="${pageContext.request.contextPath }/itemDel.action?id=${item.id}">删除</a>
					</td>
				</tr>
			</c:forEach>
				...
				<div class="modal-body">
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="edit_customerName" placeholder="姓名" name="name">
							</div>
						</div>
						<div class="form-group">
