...
<%-- 						<a
						...
						<button type="button" class="btn btn-primary" onclick="onShowEditDialog()">修改111</button>
					</td>
				</tr>
			</c:forEach>
	...
	<script type="text/javascript">
		function onShowEditDialog() {
			alert("ssss11");
			$("#edit_cust_id").val("aa");
			$("#edit_customerName").val("aa");
			$("#edit_customerFrom").val("aa")
			$("#edit_custIndustry").val("aa")
			$("#edit_custLevel").val("aa")
			$("#edit_linkMan").val("aa");
			$("#edit_phone").val("aa");
			$("#edit_mobile").val("aa");
			$("#edit_zipcode").val("aa");
